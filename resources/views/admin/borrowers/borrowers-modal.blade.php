    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="exampleModalLabel">Borrow Items</h3>
                <a class="btn" data-dismiss="modal" aria-label="Close">
                    <i class="bi bi-x-circle"></i>
                </a>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="form-row">
                            <div class="col">
                                <label for="brnumber">BR No.</label>
                                <input type="text" required name="brnumber" id="brnumber" class="form-control"
                            ...
                            <div class="col">
                                ...
                                <input type="date" required name="dateofreturn" id="dateofreturn" class="form-control"
                                    value="{{ old('dateofreturn', '') }}" placeholder="Enter Date of Return" />
                                @error('dateofreturn')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="{{ url('admin/orders/'.$order_item->id) }}" method="POST"
