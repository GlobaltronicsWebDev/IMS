                    ...
                    <tbody>
                        @forelse ($borrowers as $borrower)
                            <tr>
                                ...
                                {{-- -
                        <td><a href="{{ url('admin/borrowers/'.$item->id) }}" class="btn btn-primary btn-sm">View</a>
                            <a href="{{ url('admin/borrowers/'.$item->id.'/delete') }}" onclick="return confirm('Are you sure you want to delete this data?')" class="btn btn-danger btn-sm">Delete</a></td> - --}}
                            </tr>
                            ...
                            <div class="modal fade" id="updateCheckoutModal-{{ $borrower->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('admin/borrowers/'.$borrower->id) }}" method="POST"enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <div class="form-row">
