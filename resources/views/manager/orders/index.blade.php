        ...
        <div class="card-header">
            <h3 class="mt-2">CHECK-OUT
              ...
              {{---  <form action="{{url('manager/orders/search')}}" method="get">
                ...
                <a class="btn btn-warning btn-sm text-white float-right mx-1" data-toggle="modal" data-target="#staticBackdrop"
                     title="Generate DR Form PDF File">DR Form</a>
                            ...
                            <div class="modal fade" id="updateCheckoutModal-{{ $order_item->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('manager/orders/'.$order_item->id) }}" method="POST"enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" required name="drnumber" id="drnumber"
                                                            class="form-control" value="{{ old('drnumber',$order_item->drnumber) }}"
